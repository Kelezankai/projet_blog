...
<div class="container mx-auto p-4">
    ...
    <form action="{{ route('register.store') }}" method="POST" class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-8">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center border border-gray-300 rounded-md p-2 focus-within:border-orange-500 transition duration-300 ease-in-out">
                <i class="fas fa-user-alt text-gray-500 mr-3"></i>
                <input type="text" id="firstname" name="firstname" class="w-full p-2 bg-transparent focus:outline-none text-gray-700 placeholder-gray-500" placeholder="Prénom" required>
            </div>
        </div>
        ...
        <div class="mb-6">
            <label for="password_confirmation" class="block text-sm font-semibold text-gray-700">Confirmer le mot de passe</label>
            <div class="flex items-center border border-gray-300 rounded-md p-2 focus-within:border-orange-500 transition duration-300 ease-in-out">
                <i class="fas fa-lock text-gray-500 mr-3"></i>
                <input type="password" id="password_confirmation" name="password_confirmation" class="w-full p-2 bg-transparent focus:outline-none text-gray-700 placeholder-gray-500" placeholder="Confirmer le mot de passe" required>
            </div>
